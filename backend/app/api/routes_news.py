...
async def get_world_news(
    ...
    return await news_service.get_world_news(category=category, page=page, page_size=page_size)
...
async def get_india_news(
    ...
    return await news_service.get_india_news(category=category, page=page, page_size=page_size)
